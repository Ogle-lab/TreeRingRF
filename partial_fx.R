...
save(var1LowPlotdata, file = paste0("rf_objects/", species, "_", var1,
                                    "_plotdata_low.R"))
...
save(var1HighPlotdata, file = paste0("rf_objects/", species, "_", var1,
                                     "_plotdata_high.R"))
...
save(pdataLow, file = paste0("rf_objects/", species, "_", var1, "_x_", var2,
                             "_plotdata_low.R"))
...
save(var1LowPlotdata2, file = paste0("rf_objects/", species, "_", var1, "_x_", var2,
                                    "_plotdata_all_low.R"))
...
# save to avoidre-running the last section
save(pdataHigh, file = paste0("rf_objects/", species, "_", var1, "_x_", var2,
                              "_plotdata_high.R"))
...
# and save again
save(var1HighPlotdata2, file = paste0("rf_objects/", species, "_", var1, "_x_", var2,
